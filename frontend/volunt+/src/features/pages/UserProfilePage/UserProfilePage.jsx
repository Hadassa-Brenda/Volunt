...
export default function UserProfilePage() {
  ...
  const publishedServices = useMemo(
    () =>
      isOwnProfile
        ? servicesDTO.slice(0, 2)
        : servicesDTO.filter(
            (service) => service.provider === "Projeto Aprender",
          ),
    [isOwnProfile],
  );
    ...
    return (
      <main className="profile-page">
        ...
        <section className="profile-login-required">
          ...
          <p>Faça login para acompanhar seus serviços e denúncias.</p>
          <Link className="profile-primary-button" to="/login">
      ...
      <div className="profile-container">
        ...
        <section className="profile-cover">
          ...
          <div className="profile-identity">
            <span>{user.profileType || "Voluntário"}</span>
            <h1>{name}</h1>
            <p>
              {user.bio ||
                "Pessoa participante da comunidade Voluntá+, conectando habilidades a iniciativas que geram impacto social."}
            </p>
        ...
        <div className="profile-content-grid">
          <section className="profile-panel">
            <div className="profile-panel-title">
              <div>
                ...
                <p>Oportunidades cadastradas por este perfil.</p>
              </div>
              {isOwnProfile && (
          ...
          <aside className="profile-side">
            <section>
              <ShieldCheck />
              <h3>Perfil da comunidade</h3>
              <p>
                Confira as informações antes de combinar qualquer atividade ou
                atendimento.
              </p>
            </section>
            {isOwnProfile && (
